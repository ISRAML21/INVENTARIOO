<?php
    ...
    $rol= limpiar_cadena($_POST['id_rol']);
    ...
    $check_cargo=$check_cargo->query("SELECT id_rol FROM cargo WHERE id_rol='$rol'");
    ...
    $guardar_usuario=$guardar_usuario->prepare("INSERT INTO usuario(usuario_nombre,usuario_apellido,usuario_usuario,usuario_clave,usuario_email,id_rol) VALUES(:nombre,:apellido,:usuario,:clave,:email,:rol)");
