...
<div class="container pb-6 pt-6">
    ...
    <form action="./php/categoria_actualizar.php" method="POST" class="form_newpro" autocomplete="off">
        ...
        <div class="columns">
            <div class="control_form">
                <label>Nombre</label>
                <input class="input_produc" type="text" name="categoria_nombre" pattern="[a-zA-Z0-9áéíóúÁÉÍÓÚñÑ ]{4,50}"
                    maxlength="50" required value="<?php echo $datos['categoria_nombre']; ?>">
            </div>
        </div>
        <div class="column">
            <div class="control_form">
                <label class="control_form">Ubicación</label>
