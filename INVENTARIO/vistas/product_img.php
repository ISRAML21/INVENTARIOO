...
<div class="container pb-6 pt-6">
    ...
    <div class="form_newpro	">

        <div class="columns">
            <div class="column ">
                <h4 class="title"><?php echo $datos['producto_nombre']; ?></h4>

                <input type="hidden" name="img_del_id" value="<?php echo $datos['producto_id']; ?>">

                <?php if(is_file("./img/producto/".$datos['producto_foto'])){ ?>
                <figure class="image mb-6">
                    <img class="img_update" src="./img/producto/<?php echo $datos['producto_foto'];?>" width="300px">
                </figure>
                <form class="FormularioAjax" action="./php/producto_img_eliminar.php" method="POST" autocomplete="off">
                    ...
                    <p class="title">
                        <button type="submit" class="button_produc">Eliminar imagen</button>
                    </p>
                </form>
                <?php }else{ ?>
                <figure class="img_update">
                    <img src="./img/producto.png" width="400px">
                </figure>
                <?php } ?>
            </div>
            <div class="column">
