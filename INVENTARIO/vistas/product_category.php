            ...
            <?php
                ...
                if($categorias->rowCount()>0){
                    ...
                    foreach($categorias as $row){
                        echo '<a href="index.php?vista=product_category&category_id=
                        '.$row['categoria_id'].'" class="button_categoria">'.$row['categoria_nombre'].'</a>';
                    }
                }
                else{
        ...
        <div class="column">
            <?php
                ...
                if($check_categoria->rowCount()>0){
                    ...
                    echo '
                    <div class="container_forproduct"
                        <p>'.$check_categoria['categoria_nombre']." estan en la ".$check_categoria['categoria_ubicacion'].'</p>
                    </div>
                    ';
